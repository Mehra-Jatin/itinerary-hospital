  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-orange-500 rounded-md w-14 font-normal text-[0.8rem] dark:text-neutral-400",
        row: "flex w-full mt-2",
        cell: "h-14 w-14 text-center text-sm px-0 relative [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-neutral-100/50 [&:has([aria-selected])]:bg-neutral-100 first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20 dark:[&:has([aria-selected].day-outside)]:bg-neutral-800/50 dark:[&:has([aria-selected])]:bg-neutral-800",
        day: cn(
        ...
        day_today: "bg-orange-100 text-neutral-900 dark:bg-neutral-800 dark:text-neutral-50",
        day_outside:
