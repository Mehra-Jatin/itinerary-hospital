        ...
        >
          ...
          <div className="text-center">
            {user ? (
              <div
                onClick={logout}
                className="hover:bg-orange-700 hover:text-white py-2 px-1 rounded-md flex ml-6 cursor-pointer gap-4 top-0 relative hover:transition-all ease-in-out delay-150 hover:scale-110 duration-300"
              >
                <button>
                  <LogOutIcon />
                </button>
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex space-x-4 justify-end w-full">
              <div>
                <Button
                  variant="primary"
                  className="hover:bg-orange-200 rounded-full hover:text-orange-500 transition ease-in-out delay-150 hover:-translate-y hover:scale-110 duration-200"
                >
              ...
              <div>
                ...
                >
                  {isMobile ? <Settings className="text-lg" /> : <><Settings className="text-lg" /> Setting</>}
                </Button>
              </div>
            </div>
          </div>
